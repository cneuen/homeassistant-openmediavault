...
SENSOR_TYPES = {
    ...
    "system_gpuUtilization": OMVSensorEntityDescription(
        key="system_gpuUtilization",
        name="GPU load",
        ...
        ha_group="System",
        data_path="gpuinfo",
        data_attribute="load_percent",
        data_name="",
        data_uid="",
        data_reference="",
    ),
    "system_gpu_freq_cur": OMVSensorEntityDescription(
        key="system_gpu_freq_cur",
        name="GPU Current Frequency",
        icon="mdi:expansion-card-variant",
        ...
        ha_group="System",
        data_path="gpuinfo",
        data_attribute="cur_freq",
        data_name="",
        data_uid="",
        data_reference="",
    ),
    "system_gpu_freq_max": OMVSensorEntityDescription(
        key="system_gpu_freq_max",
    ...
    "raid": OMVSensorEntityDescription(
        key="raid",
        name="",
        ...
        ha_group="RAID",
        data_path="raid",
        data_attribute="health",
        data_name="device",
        data_uid="",
        data_reference="device",
        data_attributes_list=["state", "level", "health_indicator", "action_percent"],
    ),
